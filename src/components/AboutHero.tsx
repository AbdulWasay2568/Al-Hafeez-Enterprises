...
const AboutHero = () => {
  const stats = [
    { icon: <FaRocket className="text-2xl text-blue-500" />, number: "150+", label: "Projects Delivered" },
    { icon: <FaUsers className="text-2xl text-teal-500" />, number: "75+", label: "Happy Clients" },
    { icon: <FaLightbulb className="text-2xl text-purple-500" />, number: "5+", label: "Years Innovation" },
    { icon: <FaGlobe className="text-2xl text-green-500" />, number: "25+", label: "Countries Served" }
  ];
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-block bg-gradient-to-r from-blue-500 to-teal-500 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
              About Rhodium Tech
            </span>
          </motion.div>
