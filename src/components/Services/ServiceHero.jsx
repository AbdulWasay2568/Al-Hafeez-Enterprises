...
const ServiceHero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-teal-500/20 rounded-full blur-xl animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          >
            ...
            innovative mobile applications, and intelligent AI solutions that drive your business forward.
          </motion.p>
          ...
          >
            <button className="bg-gradient-to-r from-blue-500 to-teal-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-blue-600 hover:to-teal-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
